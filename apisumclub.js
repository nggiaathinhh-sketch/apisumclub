...
// GET /api/txmd5sum/history (ENDPOINT MỚI THEO YÊU CẦU)
app.get("/api/txmd5sum/history", async () => { 
...
`;
    ...
    console.log(`   ➜ GET /api/txmd5sum/history   → http://${publicIP}:${PORT}/api/txmd5sum/history`);
};
